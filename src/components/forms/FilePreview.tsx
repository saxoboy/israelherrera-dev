  ...
  return imagesType.includes(file.type) ? (
        ...
        <div className='ml-4 flex flex-shrink-0 items-center space-x-2'>
          ...
          {!readOnly && (
            <button
              ...
              className='text-red-500 focus:ring-red-500 hover:text-red-700 rounded text-xl font-medium focus:outline-none focus:ring'
            >
              <HiX />
            </button>
          )}
    ...
    >
      ...
      <div className='ml-4 flex flex-shrink-0 items-center space-x-2'>
        ...
        {!readOnly && (
          <button
            className='text-red-500 focus:ring-red-500 hover:text-red-700 cursor-pointer rounded focus:outline-none focus:ring'
            type='button'
